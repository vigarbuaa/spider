...
import com.vigar.bean.ZhiHuPicBean;
import com.vigar.bean.ZhiHuUserBean;
...
public class Spider {
	 ...
	 * @throws Exception 
	 */
	public static String downloadPic(String url) throws Exception {
		...
		return addr+myZhihu.getQuestion();
	}
